  ...
  handleFormSubmit(e) {
    ...
    var composeURL = "";
      ...
      if (this.state.reportID === "1") {
        composeURL =
          "https://reportes.ccscontactcenter.com/reports/Pages/ReportViewer.aspx?/Comercial/Layout&rs:Embed=true&rc:Toolbar=true&rc:Parameters=false&rc:Section=' + 1 + '&FECHA_INI=" +
          fecha_ini +
          "&FECHA_FIN=" +
          fecha_fin;
      } 
